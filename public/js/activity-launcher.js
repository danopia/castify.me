var Launcher = activities.launcher = function () { this.initialize.apply(this, arguments); };

Launcher.prototype.initialize = function (data) {
  this.$dom = $('<section>');
...
Launcher.prototype.onClick = function (e) {
